...
const DIAGNOSTIC_CATALOG: &[DiagnosticEntry] = &[
    DiagnosticEntry {
        ...
        explanation: "Nous Lang currently accepts only canonical .nl source files.",
        root_cause: "The provided path does not use the required .nl extension.",
        suggested_fix: "Rename the file to use the .nl extension or pass the intended .nl source file.",
    },
    DiagnosticEntry {
        code: "N0002",
    ...
    DiagnosticEntry {
        code: "N0102",
        phase: DiagnosticPhase::Lexer,
        explanation: "Nous Lang uses indentation-only blocks.",
    ...
    DiagnosticEntry {
        ...
        root_cause: "The .nbc file is malformed, has unsupported format/version/metadata, names an unsupported or missing entry point, contains duplicate functions, or has a mismatched function table.",
