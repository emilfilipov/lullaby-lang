...
- `powershell -ExecutionPolicy Bypass -File scripts/verify_release.ps1`: run the full Alpha 1 release gate and smoke-test the packaged toolchain, including Markdown reference verification, dry-run install/uninstall PATH helpers, and checksum verification.
