...
- `cargo run -p lullaby_cli -- inspect target/run_arithmetic.lbc`: print `.lbc` artifact metadata, function signatures, and memory operation counts without executing it.
