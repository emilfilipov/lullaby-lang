...
- `crates/nous_cli/tests/`: binary-level integration tests for the CLI pipeline, including valid checks, backend execution, bytecode artifact inspection/execution, malformed artifact diagnostics, lexical errors, and semantic errors.
