...
| `L0394` | loader | Missing module file. | `import NAME` could not find `NAME.lby` in the entry file's directory. | Create `NAME.lby` next to the entry file, or fix the import name to match an existing module file. |
