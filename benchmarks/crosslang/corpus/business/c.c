...
int main(void) {
    printf("reorder_needed=%lld\n", (long long)reorder_needed(8, 10));
    printf("stock_after=%lld\n", (long long)stock_after(100, 30, 50));
    printf("bulk_price=%lld\n", (long long)bulk_price(120, 500));
    printf("shipping_cost=%lld\n", (long long)shipping_cost(1500));
    printf("tax_bracket=%lld\n", (long long)tax_bracket(5000000));
    printf("sales_commission=%lld\n", (long long)sales_commission(1000000, 250));
    printf("loyalty_points=%lld\n", (long long)loyalty_points(45678));
    printf("discount_tier=%lld\n", (long long)discount_tier(60));
    printf("unit_price=%lld\n", (long long)unit_price(10000, 8));
    printf("break_even_units=%lld\n", (long long)break_even_units(500000, 1500, 500));
    printf("gross_margin_pct=%lld\n", (long long)gross_margin_pct(6000, 10000));
    printf("net_after_fees=%lld\n", (long long)net_after_fees(100000, 290));
    printf("invoice_total=%lld\n", (long long)invoice_total(50000, 825, 1000));
    printf("late_fee=%lld\n", (long long)late_fee(5, 20000));
    printf("restock_quantity=%lld\n", (long long)restock_quantity(5, 100, 10));
    printf("profit=%lld\n", (long long)profit(120000, 90000));
    printf("roi_pct=%lld\n", (long long)roi_pct(30000, 90000));
    printf("markup_price=%lld\n", (long long)markup_price(5000, 40));
    return 0;
}
