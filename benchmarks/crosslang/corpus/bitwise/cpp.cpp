...
int main() {
    ...
    std::cout << "is_power_of_two=" << is_power_of_two(64) << "\n";
    std::cout << "highest_bit_pos=" << highest_bit_pos(181) << "\n";
    std::cout << "lowest_bit_pos=" << lowest_bit_pos(180) << "\n";
    std::cout << "bit_at=" << bit_at(181, 2) << "\n";
    std::cout << "set_bit=" << set_bit(181, 1) << "\n";
    std::cout << "clear_bit=" << clear_bit(181, 0) << "\n";
    std::cout << "toggle_bit=" << toggle_bit(181, 3) << "\n";
    std::cout << "popcount_range=" << popcount_range(0, 7) << "\n";
    std::cout << "reverse_bits_n=" << reverse_bits_n(13, 4) << "\n";
    std::cout << "hamming_distance_bits=" << hamming_distance_bits(181, 90) << "\n";
    std::cout << "next_power_of_two=" << next_power_of_two(100) << "\n";
    std::cout << "count_leading_zeros_64=" << count_leading_zeros_64(1) << "\n";
    std::cout << "parity_bit=" << parity_bit(181) << "\n";
    std::cout << "is_bit_palindrome=" << is_bit_palindrome(9, 4) << "\n";
    std::cout << "rotate_left_n=" << rotate_left_n(1, 1, 4) << "\n";
    std::cout << "extract_bits=" << extract_bits(181, 2, 3) << "\n";
    std::cout << "merge_bits=" << merge_bits(240, 15, 4) << "\n";
    return 0;
}
